...
def test_topic_finder():
    ...
    dummy_text = "Was ist OER?  Erklärvideos zu OER | OER Definition der UNESCO | Vorteile und Mehrwert von OER | OER Angebote in den Bildungsbereichen | wichtige offene Lizenzen"
